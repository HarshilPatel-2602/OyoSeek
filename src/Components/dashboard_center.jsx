...
class Dashboard_Center extends React.Component {
    componentDidMount() {
        ...
        const response = fetchTicketCount({ userId, role, ticketCategory: selectedTicketCategory }) ;
    }
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.selectedTicketCategory !== this.props.selectedTicketCategory) {
            ...
            const resoponse = fetchTicketCount({ userId, role, ticketCategory: selectedTicketCategory}) ;
        } 
    }
